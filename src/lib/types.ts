...
export type MessageKind =
  ...
  | "call"
  | "order"
  // PHASE 10: Call recording — reuses the same audio-message shape as
  // "voice" (media_url + optional call_id) but tagged distinctly so the
  // UI can show a clear "recording" label instead of looking like a
  // normal voice note.
  | "recording";
