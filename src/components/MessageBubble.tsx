      ...
      <div className={`w-full flex items-end gap-1 ${isMine ? "justify-end" : "justify-start"} group`}>
        ...
        >
          ...
          {isDeleted ? (
            ...
            <>
              {message.kind === "text" && (
                <div className="px-3.5 pt-2.5 pb-1 text-sm whitespace-pre-wrap [overflow-wrap:anywhere]">
                  {message.is_ai && (
                    <span
              ...
              {message.kind === "image" && message.media_url && (
                <div>
                  ...
                  />
                  {message.body && (
                    <div className="px-3.5 py-2 text-sm whitespace-pre-wrap [overflow-wrap:anywhere]">
                      {message.body}
                    </div>
                  )}
                </div>
              ...
              {message.kind === "voice" && message.media_url && (
                <div className="px-3.5 py-2.5">
                  {message.body && (
                    <div className={`text-[11px] font-medium mb-1.5 ${isMine ? "text-white/80" : "text-muted"}`}>
                      {message.body}
                    </div>
                  )}
              ...
              {message.kind === "recording" && message.media_url && (
                <div className="px-3.5 py-2.5">
                  <div className={`flex items-center gap-1.5 text-[11px] font-medium mb-1.5 ${
                    isMine ? "text-white/80" : "text-danger"
                  }`}>
              ...
              {message.kind === "product" && message.product_snapshot && (
                <div className="w-full max-w-[240px]">
                  ...
                  {message.body && (
                    <div className="px-3.5 pb-2.5 text-sm whitespace-pre-wrap [overflow-wrap:anywhere]">
                      {message.body}
                    </div>
                  )}
                </div>
