...
const STATUS_OPTIONS: { value: ConversationStatus; label: string; className: string }[] = [
  { value: "open", label: "Open", className: "bg-sky-500/15 text-sky-300" },
  { value: "pending", label: "Pending", className: "bg-amber-500/15 text-amber-300" },
  { value: "urgent", label: "Urgent", className: "bg-red-500/15 text-red-300" },
  { value: "resolved", label: "Resolved", className: "bg-emerald-500/15 text-emerald-300" },
];
